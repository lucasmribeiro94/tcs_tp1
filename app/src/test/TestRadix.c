...
TEST(Radix, TestRadixSucesso1)
{
  ...
  status = sort(arr, SMALL, "On", RADIX);
...
TEST(Radix, TestRadixSucesso2)
{
  ...
  status = sort(arr, MEDIUM, "On", RADIX);
...
TEST(Radix, TestRadixTamanhoFalha2)
{
  ...
  status = sort(arr, XLARGE, "On", RADIX);
...
TEST(Radix, TestRadixTamanhoFalha3)
{
  ...
  status = sort(arr, XXLARGE, "On", RADIX);
...
TEST(Radix, TestRadixTipoFalha5)
{
  ...
  arr = (int *)malloc(len); 
  memcpy(arr, sUnsorted, len);
  status = sort(arr, SMALL, "On2", RADIX);
...
TEST(Radix, TestRadixTipoFalha6)
{
  ...
  arr = (int *)malloc(len); 
  memcpy(arr, sUnsorted, len);
  status = sort(arr, SMALL, "Onlogn", RADIX);
