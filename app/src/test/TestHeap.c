...
TEST(Heap, TestHeapSucesso1)
{
  ...
  status = sort(arr, SMALL, "Onlogn", HEAP);
...
TEST(Heap, TestHeapSucesso2)
{
  ...
  status = sort(arr, MEDIUM, "Onlogn", HEAP);
...
TEST(Heap, TestHeapSucesso3)
{
  ...
  status = sort(arr, LARGE, "Onlogn", HEAP);
...
TEST(Heap, TestHeapTamanhoFalha1)
{
  ...
  status = sort(arr, TINY, "Onlogn", HEAP);
...
TEST(Heap, TestHeapTamanhoFalha2)
{
  ...
  status = sort(arr, XLARGE, "Onlogn", HEAP);
...
TEST(Heap, TestHeapTamanhoFalha3)
{
  ...
  status = sort(arr, XXLARGE, "Onlogn", HEAP);
...
TEST(Heap, TestHeapTipoFalha6)
{
  ...
  arr = (int *)malloc(len); 
  memcpy(arr, sUnsorted, len);
  status = sort(arr, SMALL, "On2", HEAP);
